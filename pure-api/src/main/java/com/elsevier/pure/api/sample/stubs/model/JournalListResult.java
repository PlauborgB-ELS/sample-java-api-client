 ...
 * A list of journals
 */
@ApiModel(description = "A list of journals")
...
public class JournalListResult {
  ...
  public JournalListResult count(Integer count) {
  ...
  **/
  ...
  public JournalListResult pageInformation(PageInformation pageInformation) {
  ...
  **/
  ...
  public JournalListResult items(List<Journal> items) {
    
    this.items = items;
    return this;
  }

  public JournalListResult addItemsItem(Journal itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<Journal>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JournalListResult journalListResult = (JournalListResult) o;
    return Objects.equals(this.count, journalListResult.count) &&
        Objects.equals(this.pageInformation, journalListResult.pageInformation) &&
        Objects.equals(this.items, journalListResult.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class JournalListResult {\n");
