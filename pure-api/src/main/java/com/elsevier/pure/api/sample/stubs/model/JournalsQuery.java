 ...
 */
@ApiModel(description = "Create a query for journals")
...
public class JournalsQuery {
  ...
  public JournalsQuery uuids(List<UUID> uuids) {
    
    this.uuids = uuids;
    return this;
  }

  public JournalsQuery addUuidsItem(UUID uuidsItem) {
    if (this.uuids == null) {
  ...
  **/
  ...
  public JournalsQuery size(Integer size) {
  ...
  **/
  ...
  public JournalsQuery offset(Integer offset) {
  ...
  **/
  ...
  public JournalsQuery orderings(List<String> orderings) {
    
    this.orderings = orderings;
    return this;
  }

  public JournalsQuery addOrderingsItem(String orderingsItem) {
  ...
  **/
  ...
  public JournalsQuery keywordURIs(List<String> keywordURIs) {
    
    this.keywordURIs = keywordURIs;
    return this;
  }

  public JournalsQuery addKeywordURIsItem(String keywordURIsItem) {
  ...
  **/
  ...
  public JournalsQuery searchString(String searchString) {
  ...
  **/
  ...
  public JournalsQuery orderBy(String orderBy) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JournalsQuery journalsQuery = (JournalsQuery) o;
    return Objects.equals(this.uuids, journalsQuery.uuids) &&
        Objects.equals(this.size, journalsQuery.size) &&
        Objects.equals(this.offset, journalsQuery.offset) &&
        Objects.equals(this.orderings, journalsQuery.orderings) &&
        Objects.equals(this.keywordURIs, journalsQuery.keywordURIs) &&
        Objects.equals(this.searchString, journalsQuery.searchString) &&
        Objects.equals(this.orderBy, journalsQuery.orderBy);
  }
