 ...
 */
@ApiModel(description = "List of publishers. Can contain a subset of all items along with the full count")
...
public class PublisherListResult {
  ...
  public PublisherListResult count(Integer count) {
  ...
  **/
  ...
  public PublisherListResult pageInformation(PageInformation pageInformation) {
  ...
  **/
  ...
  public PublisherListResult items(List<Publisher> items) {
    
    this.items = items;
    return this;
  }

  public PublisherListResult addItemsItem(Publisher itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Publishers")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PublisherListResult publisherListResult = (PublisherListResult) o;
    return Objects.equals(this.count, publisherListResult.count) &&
        Objects.equals(this.pageInformation, publisherListResult.pageInformation) &&
        Objects.equals(this.items, publisherListResult.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublisherListResult {\n");
