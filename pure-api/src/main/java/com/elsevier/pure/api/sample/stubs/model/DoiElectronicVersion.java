 ...
 */
@ApiModel(description = "DOI electronic version related to a research output.")
...
public class DoiElectronicVersion extends ElectronicVersion {
  ...
  public DoiElectronicVersion doi(String doi) {
   ...
   * @return doi
  **/
  @ApiModelProperty(required = true, value = "The DOI of the electronic version.")
  ...
  public DoiElectronicVersion versionType(ClassificationRef versionType) {
