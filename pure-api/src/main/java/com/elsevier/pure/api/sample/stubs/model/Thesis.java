...
import com.elsevier.pure.api.sample.stubs.model.ThesisAllOf;
...
public class Thesis extends ResearchOutput {
  ...
  public Thesis placeOfPublication(String placeOfPublication) {
  ...
  **/
  ...
  public Thesis numberOfPages(Integer numberOfPages) {
  ...
  **/
  ...
  public Thesis edition(String edition) {
  ...
  **/
  ...
  public Thesis printISBNs(List<String> printISBNs) {
  ...
  **/
  ...
  public Thesis electronicISBNs(List<String> electronicISBNs) {
  ...
  **/
  ...
  public Thesis publisher(PublisherRef publisher) {
  ...
  **/
  ...
  public Thesis volume(String volume) {
  ...
  **/
  ...
  public Thesis publicationSeries(List<PublicationSeries> publicationSeries) {
  ...
  **/
  ...
  public Thesis bookSeries(List<BookSeriesJournalAssociation> bookSeries) {
  ...
  **/
  ...
  public Thesis qualification(ClassificationRef qualification) {
  ...
  **/
  ...
  public Thesis supervisorOrganisations(List<OrganizationRef> supervisorOrganisations) {
    
    this.supervisorOrganisations = supervisorOrganisations;
    return this;
  }

  public Thesis addSupervisorOrganisationsItem(OrganizationRef supervisorOrganisationsItem) {
  ...
  **/
  ...
  public Thesis supervisorExternalOrganisations(List<ExternalOrganizationRef> supervisorExternalOrganisations) {
    
    this.supervisorExternalOrganisations = supervisorExternalOrganisations;
    return this;
  }

  public Thesis addSupervisorExternalOrganisationsItem(ExternalOrganizationRef supervisorExternalOrganisationsItem) {
  ...
  **/
  ...
  public Thesis supervisors(List<SupervisorAssociation> supervisors) {
  ...
  **/
  ...
  public Thesis sponsors(List<ExternalOrganizationRef> sponsors) {
  ...
  **/
  ...
  public Thesis awardDate(OffsetDateTime awardDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.placeOfPublication, thesis.placeOfPublication) &&
        ...
        Objects.equals(this.supervisorOrganisations, thesis.supervisorOrganisations) &&
        Objects.equals(this.supervisorExternalOrganisations, thesis.supervisorExternalOrganisations) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(placeOfPublication, numberOfPages, edition, printISBNs, electronicISBNs, publisher, volume, publicationSeries, bookSeries, qualification, awardingInstitutions, supervisorOrganisations, supervisorExternalOrganisations, supervisors, sponsors, awardDate, super.hashCode());
  }
