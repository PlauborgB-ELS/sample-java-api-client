 ...
 */
@ApiModel(description = "Create a query for external persons")
...
public class ExternalPersonsQuery {
  ...
  public ExternalPersonsQuery uuids(List<UUID> uuids) {
    
    this.uuids = uuids;
    return this;
  }

  public ExternalPersonsQuery addUuidsItem(UUID uuidsItem) {
    if (this.uuids == null) {
  ...
  **/
  ...
  public ExternalPersonsQuery size(Integer size) {
  ...
  **/
  ...
  public ExternalPersonsQuery offset(Integer offset) {
  ...
  **/
  ...
  public ExternalPersonsQuery orderings(List<String> orderings) {
    
    this.orderings = orderings;
    return this;
  }

  public ExternalPersonsQuery addOrderingsItem(String orderingsItem) {
  ...
  **/
  ...
  public ExternalPersonsQuery keywordURIs(List<String> keywordURIs) {
    
    this.keywordURIs = keywordURIs;
    return this;
  }

  public ExternalPersonsQuery addKeywordURIsItem(String keywordURIsItem) {
  ...
  **/
  ...
  public ExternalPersonsQuery searchString(String searchString) {
  ...
  **/
  ...
  public ExternalPersonsQuery orderBy(String orderBy) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExternalPersonsQuery externalPersonsQuery = (ExternalPersonsQuery) o;
    return Objects.equals(this.uuids, externalPersonsQuery.uuids) &&
        Objects.equals(this.size, externalPersonsQuery.size) &&
        Objects.equals(this.offset, externalPersonsQuery.offset) &&
        Objects.equals(this.orderings, externalPersonsQuery.orderings) &&
        Objects.equals(this.keywordURIs, externalPersonsQuery.keywordURIs) &&
        Objects.equals(this.searchString, externalPersonsQuery.searchString) &&
        Objects.equals(this.orderBy, externalPersonsQuery.orderBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalPersonsQuery {\n");
