 ...
 */
@ApiModel(description = "Create a query for researchOutputs")
...
public class ResearchOutputsQuery {
  ...
  public ResearchOutputsQuery uuids(List<UUID> uuids) {
    
    this.uuids = uuids;
    return this;
  }

  public ResearchOutputsQuery addUuidsItem(UUID uuidsItem) {
    if (this.uuids == null) {
  ...
  **/
  ...
  public ResearchOutputsQuery size(Integer size) {
  ...
  **/
  ...
  public ResearchOutputsQuery offset(Integer offset) {
  ...
  **/
  ...
  public ResearchOutputsQuery orderings(List<String> orderings) {
    
    this.orderings = orderings;
    return this;
  }

  public ResearchOutputsQuery addOrderingsItem(String orderingsItem) {
  ...
  **/
  ...
  public ResearchOutputsQuery keywordURIs(List<String> keywordURIs) {
    
    this.keywordURIs = keywordURIs;
    return this;
  }

  public ResearchOutputsQuery addKeywordURIsItem(String keywordURIsItem) {
  ...
  **/
  ...
  public ResearchOutputsQuery searchString(String searchString) {
  ...
  **/
  ...
  public ResearchOutputsQuery orderBy(String orderBy) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchOutputsQuery researchOutputsQuery = (ResearchOutputsQuery) o;
    return Objects.equals(this.uuids, researchOutputsQuery.uuids) &&
        Objects.equals(this.size, researchOutputsQuery.size) &&
        Objects.equals(this.offset, researchOutputsQuery.offset) &&
        Objects.equals(this.orderings, researchOutputsQuery.orderings) &&
        Objects.equals(this.keywordURIs, researchOutputsQuery.keywordURIs) &&
        Objects.equals(this.searchString, researchOutputsQuery.searchString) &&
        Objects.equals(this.orderBy, researchOutputsQuery.orderBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchOutputsQuery {\n");
