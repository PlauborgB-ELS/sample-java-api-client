 ...
 */
@ApiModel(description = "List of api keys. Can contain a subset of all items along with the full count")
...
public class ApiKeyListResult {
  ...
  public ApiKeyListResult count(Integer count) {
  ...
  **/
  ...
  public ApiKeyListResult pageInformation(PageInformation pageInformation) {
  ...
  **/
  ...
  public ApiKeyListResult items(List<ApiKey> items) {
    
    this.items = items;
    return this;
  }

  public ApiKeyListResult addItemsItem(ApiKey itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<ApiKey>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.count, apiKeyListResult.count) &&
        Objects.equals(this.pageInformation, apiKeyListResult.pageInformation) &&
        Objects.equals(this.items, apiKeyListResult.items);
  }
